...
const InviteExpert = ({ open, setOpenSheet, expertName, expertId }: { open: boolean, setOpenSheet: Dispatch<SetStateAction<boolean>>, expertName: string, expertId: string }) => {
            ...
            <SheetContent>
                ...
                <div className="p-4">
                    <div className="top flex flex-col gap-4 mb-4 w-full">
                        <span className="text-primary-text font-bold lg:text-base text-sm">Share some details about this project</span>
                            ...
                            >
                                <div className="form-group flex flex-col gap-2">
                                    ...
                                    <span className="text-xs text-[#2585D7]">
                                        Feel free to elaborate and add all the necessary info
                                        including links
                                    </span>
                                </div>
