            ...
            <div className="flex flex-col items-center gap-[9px] w-full px-4 lg:px-14 py-4 bg-[url('/images/blur-bg.svg')]">
                <div className="flex flex-col items-center justify-center gap-6 w-full lg:w-[560px] py-5 lg:py-20">
                    <div className="top flex flex-col gap-4 items-center justify-center w-full">
                        <span className="text-primary-text font-bold lg:text-[32px] text-center text-xl">{ comingFromExpert ? 'Share some details about this project' : 'Whats Your Business Challenge.'}</span>
                        <span className="text-secondary-text text-sm lg:text-base font-medium text-center">{comingFromExpert ? `This will help ${expertName} better understand your needs` : "Tell us your biggest business challenge we'll analyze it and build a solution."}</span>
                    </div>
