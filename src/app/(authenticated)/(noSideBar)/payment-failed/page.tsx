    ...
    return (
        <div className="flex justify-center px-4 h-screen py-20">
            <div className="w-full lg:w-[547px] flex flex-col gap-6">
                <Image src={'/icons/payment-failed.svg'} alt="Payment Successful" width={54} height={54} />
                <span className="font-bold text-xl text-[#0E1426] lg:text-[32px]">Payment failed</span>
