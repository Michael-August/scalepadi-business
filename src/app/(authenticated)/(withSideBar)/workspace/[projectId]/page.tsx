    ...
    <div className="flex w-full flex-col gap-6">
        ...
        {activeTab === "projectOverview" && (
          <div className="w-full border border-[#F2F2F2] rounded-2xl p-6 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="text-sm text-[#727374]">
                Increase weekly customer sign-ups by 30% in 6 weeks through
                acquisition funnel optimization and sales outreach.
              </span>
            </div>
            {/* <div className="flex flex-col gap-2">
                  ...
                  {project?.data?.experts?.map((expert: any) => (
                    <div className="flex items-center gap-2">
                      <div className="w-[52px] relative h-[52px] rounded-full">
                        <Image
                          src={(expert?.profilePicture as string) || noAvatar}
                          alt="Profile Picture"
                          width={52}
                          height={52}
                  ...
                  <div key={task.id} className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      {task?.submission?.length === 0 && (
                        <span className="text-sm text-[#727374]">
                          No documents have been submitted for this task yet
                        </span>
                      )}
                      {/* Submissions */}
      ...
      <Dialog open={openRejectReason} onOpenChange={setOpenRejectReason}>
        <DialogContent className="!rounded-3xl">
          ...
          <div className="flex flex-col gap-6">
            <span className="text-[#878A93] text-sm">
              Kingly write detailed information as regards to why the submitted
              project has been rejected and what you want the expert to do?
            </span>
            <div className="form-group flex flex-col gap-2">
              <Label>Write your feedback</Label>
              <Textarea 
