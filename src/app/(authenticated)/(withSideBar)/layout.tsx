...
export default function RootLayout({
  ...
  return (
    <div className="flex overflow-hidden">
      <div className="hidden lg:flex h-full w-[17.25rem] bg-white fixed left-0 top-0 z-30 border-r border-[#EDEEF3]">
        <SideBar />
      </div>
      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          {/* Sliding panel */}
          <div className="fixed top-0 left-0 h-full w-[17.25rem] bg-white border-r border-[#EDEEF3] shadow-lg transform transition-transform duration-300 ease-in-out translate-x-0">
