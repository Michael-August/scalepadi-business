    ...
    queryFn: async () => {
      try {
        ...
        if (error instanceof AxiosError) {
          ...
          toast.error("An unexpected error occured while fetching challenges");
        }
    ...
    queryFn: async () => {
      try {
        ...
        if (error instanceof AxiosError) {
          ...
          toast.error("An unexpected error occured while fetching challenge");
        }
    ...
    mutationFn: async (data: any) => {
      try {
        ...
        if (res.data?.status === false) {
          throw new Error(
            res.data?.message || "An error occurred while creating challenge"
          );
        }
        return res.data;
      } catch (error: any) {
        if (error instanceof AxiosError) {
          ...
          toast.error("An unexpected error occured while creating challenge.");
        }
